...
import {
  require_pickBy
} from "./chunk-7WVNBV2D.js";
import {
  require_mapValues
} from "./chunk-KPBUDKJW.js";
import {
  require_cloneDeep
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react4.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react4.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react4.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = scope, copyToClipboard = (0, import_react4.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-VZQWAYUJ.js");
...
var LazyColorControl = (0, import_react14.lazy)(() => import("./Color-3YIJY6X7-6KBTAGNN.js"));
...
var HeaderMdx = (props) => {
  ...
  return import_react49.default.createElement(Component4, { ...nameSpaceClassNames(withoutAs, as) });
};
...
//# sourceMappingURL=chunk-CVV6N7D7.js.map
